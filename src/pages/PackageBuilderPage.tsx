...
const PackageBuilderPage: React.FC = () => {
  ...
  const resortId = "chamonix"; // Hardcoded for now, replace with dynamic logic if needed
  ...
  const filteredHotels = resortId ? MOCK_HOTELS[resortId] || [] : [];
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-neutral-600 mb-8">
            Customize your perfect ski trip by selecting flights, accommodation,
            and transfers.
          </p>
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                ...
                className={`flex flex-col items-center ${
                  stepStatus.flight === "pending"
                    ? "text-neutral-400"
                    : stepStatus.flight === "active"
                    ? "text-primary-600"
                    : "text-secondary-600"
                }`}
              ...
              <button
                onClick={() =>
                  packageState.selectedFlight && setActiveStep("hotel")
                }
                className={`flex flex-col items-center ${
                  stepStatus.hotel === "pending"
                    ? "text-neutral-400"
                    : stepStatus.hotel === "active"
                    ? "text-primary-600"
                    : "text-secondary-600"
                }`}
              ...
              <button
                onClick={() =>
                  packageState.selectedHotel && setActiveStep("transfer")
                }
                className={`flex flex-col items-center ${
                  stepStatus.transfer === "pending"
                    ? "text-neutral-400"
                    : stepStatus.transfer === "active"
                    ? "text-primary-600"
                    : "text-secondary-600"
                }`}
              ...
              <button
                onClick={() =>
                  packageState.selectedTransfer && setActiveStep("review")
                }
                className={`flex flex-col items-center ${
                  stepStatus.review === "pending"
                    ? "text-neutral-400"
                ...
                <div className="flex justify-between items-center mb-6">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="flex items-center border rounded-md">
                      <button
                        onClick={() =>
                          handlePassengerChange(packageState.passengerCount - 1)
                        }
                        ...
                        <div className="bg-gray-50 p-4 border-t">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                              ...
                              <p className="text-sm mb-1">
                                <span className="font-medium">Baggage:</span> 1
                                carry-on, 1 checked bag (23kg)
                              </p>
                              <p className="text-sm">
                            ...
                            <div>
                              ...
                              <p className="text-sm mb-1">
                                ...
                                €{Math.round(flight.price * 0.7)} per person
                              </p>
                              <p className="text-sm mb-1">
                                <span className="font-medium">
                                  Taxes & fees:
                                </span>{" "}
                                €{Math.round(flight.price * 0.3)} per person
                              </p>
                              <p className="text-sm font-medium">
                                <span className="font-medium">Total:</span> €
                                {flight.price * packageState.passengerCount} for{" "}
                                {packageState.passengerCount} passenger
                                {packageState.passengerCount !== 1 ? "s" : ""}
                              </p>
                            </div>
                          </div>
                        </div>
                  ...
                  {filteredHotels.length > 0 ? (
                            ...
                            <div className="flex-grow">
                              ...
                              <div className="mt-3 flex items-center">
                                ...
                                <span className="text-sm text-neutral-600">
                                  {hotel.liftDistanceMeters}m from lifts
                                </span>
                              </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              ...
                              <div>
                                ...
                                <p className="text-sm mb-1">
                                  ...
                                  €{Math.round(hotel.pricePerNight * 7 * 0.1)}
                                </p>
                                <p className="text-sm font-medium">
                                  <span className="font-medium">Total:</span> €
                                  {hotel.pricePerNight * 7 +
                                    Math.round(hotel.pricePerNight * 7 * 0.1)}
                                </p>
                                <p className="text-xs text-neutral-500 mt-2">
                                  Cancellation policy: Free cancellation up to 7
                                  days before arrival
                                </p>
                              </div>
                            </div>
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-neutral-500 mt-2">
                        Please select a different resort or try again later.
                      </p>
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-4">
                  {MOCK_TRANSFERS.filter(
                    (transfer) =>
                      packageState.selectedFlight &&
                      transfer.origin ===
                        packageState.selectedFlight.destination
                  ).map((transfer) => (
                    <div
                      key={transfer.id}
                      className={`border rounded-lg overflow-hidden transition-all ${
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                              ...
                              <p className="text-sm mb-1">
                                ...
                                {transfer.origin} Airport arrivals hall
                              </p>
                              <p className="text-sm mb-1">
                                <span className="font-medium">Dropoff:</span>{" "}
                                Your accommodation in {transfer.destination}
                              </p>
                              <p className="text-sm mb-1">
                                <span className="font-medium">Luggage:</span> 1
                                suitcase + 1 ski/board bag per person
                              </p>
                              {transfer.type === "shared" && (
                                <p className="text-sm text-neutral-500 mt-2">
                                  Note: Shared transfers may involve stops at
                            ...
                            <div>
                              ...
                              <p className="text-sm font-medium">
                                <span className="font-medium">Total:</span> €
                                {transfer.price * packageState.passengerCount}
                              </p>
                              <p className="text-xs text-neutral-500 mt-2">
              ...
              >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      {packageState.selectedFlight && (
                        <div className="border-b md:border-b-0 md:border-r border-gray-200 pb-4 md:pb-0 md:pr-4">
                          ...
                          <p className="font-semibold">
                            {packageState.selectedFlight.origin} to{" "}
                            {packageState.selectedFlight.destination}
                          </p>
                          <p className="text-sm">
                          ...
                          <p className="text-sm text-neutral-500">
                            {new Date(
                              packageState.selectedFlight.departureTime
                            ).toLocaleDateString()}{" "}
                            at{" "}
                            {new Date(
                              packageState.selectedFlight.departureTime
                      ...
                      {packageState.selectedHotel && (
                        <div className="border-b md:border-b-0 md:border-r border-gray-200 py-4 md:py-0 md:px-4">
                          ...
                          <p className="text-sm">
                            {Array.from({
                              length: packageState.selectedHotel.starRating,
                            })
                              .map((_, i) => "★")
                              .join("")}
                          </p>
                      ...
                      {packageState.selectedTransfer && (
                        <div className="pt-4 md:pt-0 md:pl-4">
                          ...
                          <p className="font-semibold">
                            {packageState.selectedTransfer.type === "private"
                              ? "Private Transfer"
                              : "Shared Shuttle"}
                          </p>
                          <p className="text-sm">
                            {packageState.selectedTransfer.origin} to{" "}
                            {packageState.selectedTransfer.destination}
                          </p>
                          <p className="text-sm text-neutral-500">
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      <p>
                        Flights ({packageState.passengerCount} x €
                        {packageState.selectedFlight?.price})
                      </p>
                    ...
                    <div className="flex justify-between">
                      <p>
                        Transfers ({packageState.passengerCount} x €
                        {packageState.selectedTransfer?.price})
                      </p>
                ...
                <div className="flex justify-between items-center pt-4 border-t">
                  <p className="text-sm text-neutral-500">
                    Quote valid until:{" "}
                    {new Date(
                      packageState.packageQuote.expiresAt
                    ).toLocaleTimeString()}
                  </p>
